...
from services.alerts import build_alerts, main as alerts_main
...
def test_breach_alert_includes_trigger(tmp_path: Path):
    ...
    evm = _make_evm_df([
        {"ProjectID": "P1", "WBS": "W1", "Period": "2025-01-01", "CPI": 0.88, "SPI": 0.80, "VAC": -1.0, "BAC": 100.0, "EAC": 120.0},
        {"ProjectID": "P1", "WBS": "W1", "Period": "2025-02-01", "CPI": 0.85, "SPI": 0.82, "VAC": -2.0, "BAC": 100.0, "EAC": 125.0},
    ])
...
def test_summary_alert_normalizes_legacy_key_and_writes_file(tmp_path: Path):
    ...
    evm = _make_evm_df([
        {"ProjectID": "G1", "WBS": "W1", "Period": "2025-01-01",
         "CPI": 1.05, "SPI": 1.02, "VAC": 5000.0, "BAC": 95000.0, "EAC": 100000.0}
    ])
